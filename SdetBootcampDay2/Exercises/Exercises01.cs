...
namespace SdetBootcampDay2.Exercises
{
    ...
    //      */
    //     [Test]
    //     // public void Add0StockForDayOfTheTentacle_OrderFromStock_ShouldYieldArgumentException()
    //     // {
    //     //     Dictionary<OrderItem, int> stock = new Dictionary<OrderItem, int>{{OrderItem.DayOfTheTentacle, 0}};
    //     //     //var orderHandler = new OrderHandler(new PaymentProcessor(PaymentProcessorType.Stripe), stock);
    ...
    //     // {
    //     //     Dictionary<OrderItem, int> stock = new Dictionary<OrderItem, int>{{OrderItem.FIFA_24, 10}};
    //     //     //var orderHandler = new OrderHandler(new PaymentProcessor(PaymentProcessorType.Stripe), stock);
    ...
    //     // {
    //     //     Dictionary<OrderItem, int> stock = new Dictionary<OrderItem, int>{{OrderItem.Fortnite, 0}};
    //     //     var orderHandler = new OrderHandler(new PaymentProcessor(PaymentProcessorType.Stripe), stock);
